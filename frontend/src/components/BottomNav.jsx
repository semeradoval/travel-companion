...
export default function BottomNav() {
  ...
  return (
    <nav style={{
      ...
      <button onClick={() => navigate('/entry/create')} style={navItemStyle(pathname.includes('/entry/create'))}>
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={pathname.includes('/entry/create') ? 'white' : '#9ca3af'} strokeWidth="2.5" strokeLinecap="round">
